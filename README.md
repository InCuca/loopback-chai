...
expect(modelJson).to.haveMany('relationship')
expect(modelJson).to.haveMany('relationship', 'RelatedModel')
expect(modelJson).to.haveMany('relationship', 'RelatedModel', 'relatedModelId')
```
